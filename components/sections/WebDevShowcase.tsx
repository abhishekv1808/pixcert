  ...
  return (
    <motion.a
      ...
      style={
        reduced
          ? undefined
          : { rotateX, y, transformPerspective: 1600 }
      }
...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <motion.a
      ...
      style={reduced ? undefined : { transformPerspective: 1000 }}
      className="group overflow-hidden rounded-2xl border border-ink/10 bg-white shadow-sm transition-shadow duration-300 will-change-transform hover:shadow-lg"
    >
...
export default function WebDevShowcase() {
  ...
  return (
    <section id="recent-builds" className="bg-cream py-24 lg:py-32">
